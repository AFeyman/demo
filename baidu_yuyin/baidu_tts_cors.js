        ...
        if (xhr.readyState == 4) {
            ...
            if (xhr.status == 200) {
                if (xhr.response.type === 'audio/mp3') {
                    ...
                    $('.box:last').append(audio);
                    // document.body.append(audio);
                    $('.box:last').append('<button class="bf">播放</button><a download="" class="da" href="'+URL.createObjectURL(xhr.response)+'" class="download">下载</a><button class="del">删除</button>');
